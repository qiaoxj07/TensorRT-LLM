...
if _BACKEND == "python":
    ...
    # SsmSnapshotIterationStatsDelta is a plain dataclass with no C++ counterpart
    # yet (_stats only depends on `dataclasses`), so fall back to the Python one.
    from ._stats import SsmSnapshotIterationStatsDelta  # noqa: F401
